...
class CourseFragment : Fragment() {
    ...
    private var scheduleLab : Schedule? = null
    private var mode = 0
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            ...
            if (button_mon?.isSelected) {
                ...
                filterAdapter.setItemClickListener(object : CoursesAdapter.ItemClickListener {
                    override fun onItemClick(position: Int) {
                        ...
                        inputDataProcessing(filteredList[position], jArray)
                    }
                })
        ...
        mAdapter.setItemClickListener(object : CoursesAdapter.ItemClickListener {
            override fun onItemClick(position: Int) {
                Toast.makeText(context, "Course added to cart", Toast.LENGTH_SHORT).show()
                inputDataProcessing(dataList[position], jArray)
...
//        cart_recycle.layoutManager = cart_lm.also { it.orientation = LinearLayoutManager.HORIZONTAL }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.save) {
            if (mode == ScheduleFragment.REQUEST_ADD_COURSE) {
                ...
                schedules3.add(scheduleLab)
                i.putExtra("schedules", schedules)
                i.putExtra("schedules2", schedules2)
                i.putExtra("schedules3", schedules3)
    ...
    private fun inputDataProcessing(data: CoursesData, array: JSONArray){
